...
const Contact = () => {
  return (
    <section id="kontakt" className="w-full py-10 sm:px-8 px-4">
      <div className="max-w-[700px] mx-auto">
        <div className="flex sm:items-center flex-col sm:flex-row items-center justify-center gap-4 text-sm sm:text-base ">
          {/* CONTACT */}
          <p className="uppercase whitespace-nowrap font-semibold tracking-wider text-sm sm:text-lg ">
            Contact
          </p>
          {/* Line mobile (vertical) */}
          <div className="block sm:hidden h-8 border-l border-black/20"></div>

          {/* Line desktop (horizontal) */}
          <div className="hidden sm:block flex-1 border-b border-black/20"></div>
        ...
        <div className="flex justify-between md:my-5 mt-10  max-w-[500px] mx-auto ">
