          ...
          {projects.map((item, index) => {
            ...
            return (
              <li key={index} className="h-full">
                <Link
                  href={`/projects/${slug}`}
                  className="group flex h-full flex-col overflow-hidden border border-black/10 bg-white shadow-sm transition hover:-translate-y-1 hover:shadow-lg"
                >
                  ...
                  <div className="p-4 sm:p-5 flex flex-1 flex-col">
                    ...
                    {/* mt-auto gura ovo na dno kartice */}
                    <p className="mt-auto pt-4 inline-flex items-center gap-2 text-xs font-medium uppercase tracking-[0.2em] text-black/70 transition group-hover:text-black">
                      Vidi projekt{" "}
